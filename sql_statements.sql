...
VALUES
('12','2452','3543', 'blah blah blah', '1', 'open', '2017-10-05 14:32:56', NULL),
('13','2453','6524', 'blah blah blah', '2', 'closed', '2017-10-06 14:32:56', '2017-10-09 14:32:56'),
('72','2454','1232', 'blah blah blah', '1', 'open', '2017-10-07 14:32:56', NULL),
('15','2455','123', 'blah blah blah', '4', 'open', '2017-10-08 14:32:56', NULL),
('12','2456','987', 'blah blah blah', '1', 'pending', '2017-10-09 14:32:56', NULL),
('13','2457','9876', 'blah blah blah', '5', 'open', '2017-10-10 14:32:56', NULL)
...
INSERT INTO Problem_Status (Problem_ID, Status_ID, Comment, Account_ID, Status_Date)
VALUES
...
INSERT INTO Problem_Counter (Problem_Type_ID, Occurrences)
VALUES
('1','142'),
('2','124'),
('3','152'),
...
INSERT INTO Problem_Type (Problem_Type_Name)
VALUES
('networking'),
('security'),
('email'),
...
INSERT INTO Solution (Solution_Desc, Solution_Counter)
VALUES
('this is the solution to problems with the id 2 and 3', '2')

INSERT INTO Solution_Problem (Solution_ID, Problem_ID)
VALUES
('1', '2'),
('1', '3')
